...
**MealPlan** is a smart meal preparation, macro tracking, and recipe scaling platform designed to help you achieve your exact dietary goals without the hassle of manual math.
...
1. **[Create an Account](getting-started/account-setup.md)** and verify your email address.
2. **[Configure Your Nutrition Goals](getting-started/nutrition-goals.md)** in Settings (daily calories, protein, carb, and fat splits).
3. **[Build or Import Recipes](recipes/recipe-builder.md)** to start meal prepping!
